...
<div class="navigacios-sav">
    ...
    <div class="navigacios-sav-jobb">
        ...
        <div class="profil-container">
            <button class="profil-gomb">Profil</button>
            <div class="profil-dropdown">
                <div class="dropdown-item belépés" onclick="belepes()">Belépés</div>
                <div class="dropdown-item regisztráció" onclick="regisztracio()">Regisztráció</div>
            </div>
        </div>
    </div>
</div>
